...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function validarFormulario() {
        if (nombreInput.classList.contains('valid') &&
            ...
            sugerenciasInput.classList.contains('valid')) {
...
function sendData(nombre, email, sugerencias) {
    ...
    xhr.open('POST', 'POST/sugerencias_parque', true);
    ...
    xhr.onerror = function () {
        ...
        errorMessageElement.textContent = 'Se ha producido un error de red. Por favor, revisa tu conexión a Internet e intenta de nuevo.';
    };
